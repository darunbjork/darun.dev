...
export class PitchService {
  ...
  async generate(jdText: string): Promise<PitchResponse> {
    ...
    const prompt = [
      ...
      "--- JD END ---",
      "",
      "Important: gapSkills must contain ONLY skills, tools, or role-relevant experience. Geographic location, work authorization, and language proficiency belong in fitSummary only — never in gapSkills or matchedSkills.",
      "",
      ...
      '    "gapSkills": ["skills, tools, or role-relevant experience the candidate lacks — NEVER include location, time zone, right-to-work status, native language, or any non-skill personal circumstance"],',
